...
Vue.component('usuario-component', Object(function webpackMissingModule() { var e = new Error("Cannot find module 'components/UsuariosComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var app = new Vue({
  el: '#app'
});
